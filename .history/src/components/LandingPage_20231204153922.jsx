...
const LandingPage = () => {
  ...
  const handleEditStudent = (student) => {
    // Check if fetched student data includes the 'family' property
    if ('family' in student) {
      setSelectedStudent(student);
      setShowModal(true);
    } else {
      // Handle the case where 'family' property is missing
      // Log an error or handle it accordingly
      console.error('Family information is missing for the selected student.');
    }
  };
