...
const LandingPage = () => {
  ...
  useEffect(() => {
    fetchStudents()
      .then((data) => {
        setStudents(data);
        // Fetch nationality for each student
        data.forEach((student) => {
          fetchStudentNationality(student.id)
            .then((nationality) => {
              // Handle nationality data for each student here
              console.log(`Nationality for student ${student.id}:`, nationality);
              // You can update the state or perform any necessary actions with the fetched nationality data
            })
            .catch((error) => {
              console.error(`Error fetching nationality for student ${student.id}:`, error);
