...
const StudentModal = ({ student, closeModal }) => {
 ...
 return (
<div className="fixed z-10 inset-0 display-flex flex-col items-center justify-center overflow-x-auto">
      <div className="flex items-center justify-center min-h-screen">
        <div className="bg-white rounded-lg p-8 m-4 max-w-xl">
          ...
          <div className="mb-4">
            ...
            <select className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="nationality" name="nationality" value={values.nationality} onChange={handleChange}>
